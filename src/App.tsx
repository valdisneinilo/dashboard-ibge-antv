...
import { Button, Form, Select, Space, notification, Row, Col } from "antd";
import {
  SearchOutlined,
  AreaChartOutlined,
  PieChartOutlined,
    ...
    <Container>
      ...
      >
        <Space className="form">
          <Row gutter={24}>
            <Col xs={24} sm={12} md={12} lg={6} style={{ width: "100%" }}>
              <Form.Item
                label="País"
                name="pais"
                rules={[
            ...
            <Col xs={24} sm={12} md={12} lg={6} style={{ width: "100%" }}>
              ...
              >
                ...
                >
                  ...
                  <Option value="indicadores-sociais">
                    Indicadores sociais
                  </Option>
              ...
              {assunto === "indicadores-sociais" && (
                ...
                >
                  <Select>
                    ...
                    <Option value="77836">
                      Taxa de alfabetização das pessoas de 15 anos ou mais de
                      idade
                    </Option>
                  </Select>
                </Form.Item>
            ...
            <Col xs={24} sm={12} md={12} lg={6} style={{ width: "100%" }}>
              {assunto === "redes" && (
                ...
                >
                  <Select>
                    <Option value="77854">
                      Assinaturas de telefonia celular
                    </Option>
                    <Option value="77855">Assinaturas de telefonia fixa</Option>
                    <Option value="77857">
                      Indivíduos com acesso à internet
                    </Option>
                  </Select>
                </Form.Item>
              )}
