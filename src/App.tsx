...
const App: React.FC = () => {
  ...
  const handleChangePais = (value: string) => {
    console.log(`handleChangePais ${value}`);
    setPais(value);
  };
  const handleChangeAssunto = (value: string) => {
    console.log(`handleChangeAssunto ${value}`);
    setAssunto(value);
  };
    ...
    <div>
      <Space>
        ...
        {assunto === "indicadores-sociais" && (
          <Select onChange={handleChange} style={{ width: "200px" }}>
            <Option value="77830">Esperança de vida ao nascer</Option>
            <Option value="77831">Índice de desenvolvimento humano</Option>
            <Option value="77832">População com acesso à água potável</Option>
            <Option value="77833">População com acesso à rede sanitária</Option>
            <Option value="77835">
        ...
        {assunto === "populacao" && (
          <Select onChange={handleChange} style={{ width: "200px" }}>
            ...
            <Option value="77848">População residente em área urbana</Option>
      ...
      <BasicColumnPlot data={data} titulo={titulo} />
    </div>
  );
};
